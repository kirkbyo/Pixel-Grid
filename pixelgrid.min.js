function GenerateGrid(e){var r=0;for(cell_highlighted=e.cell_highlighted,grid_width=e.colums,grid=document.getElementById(setting.id);r!=e.rows;)r+=1,GenerateRow(e.colums);cell_default_background=getDefaultCellBackground()}function GenerateInnerRow(e){function r(){for(var r=0,d="";r!=e;)d+="<div></div>",r+=1;return d}var d=document.createDocumentFragment(),t=document.createElement("div");for(t.innerHTML=r();t.firstChild;)d.appendChild(t.firstChild);return d}function GenerateRow(e){var r=document.createDocumentFragment(),d=document.createElement("div");for(d.innerHTML="<div></div>";d.firstChild;)r.appendChild(d.firstChild);r.childNodes[0].appendChild(GenerateInnerRow(e)),grid.insertBefore(r,grid.childNodes[0])}function getDefaultCellBackground(){var e=grid.childNodes,r=e[0],d=r.childNodes[0];if(void 0!=d){var t=getComputedStyle(d,null).getPropertyValue("background-color");return t}return"green"}var cell_highlighted="red",cell_default_background="green",grid_width=0,grid="";
